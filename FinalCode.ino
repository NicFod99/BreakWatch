...
struct Object {
  ...
  int healthPoints;     // Initial life given, in this case 3 Years (100 HP each), is scaled in 5 min.
...
void loop() {
  ...
  if (currentTime - lastPrintTime >= 3000) {
    ...
    Serial.print(" | TestObject HP: ");
    Serial.print(TestObject.healthPoints);
    Serial.print(" | Years Remaining: "); // Print with 2 decimal places
    Serial.print(TestObject.yearsRemaining, 2);
    Serial.print(" | Total damage dealt: ");
  ...
  delay(1000); // Wait for 1000 milliseconds before next measurement
}
